...
function ToggleField({ checked, description, disabled = false, label, onChange }: ToggleFieldProps) {
  return (
...
function ColorField({ defaultLabel, label, onChange, value }: ColorFieldProps) {
  return (
